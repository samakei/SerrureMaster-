      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between mb-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white font-bold text-lg mb-1">Votre vie privée nous appartient... non, on rigole.</h3>
              <p className="text-slate-300 text-sm leading-relaxed max-w-3xl">
                Conformément au RGPD, vous avez le choix. Nous utilisons des cookies pour sécuriser votre espace membre (essentiels) et, si vous l'acceptez, pour améliorer nos guides (analytiques).
              </p>
            </div>
          </div>
        ...
        {showDetails && (
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 mb-6 animate-fade-in">
             <div className="grid md:grid-cols-3 gap-6">
                {/* Necessary */}
                <div className="flex items-start gap-3 opacity-70 cursor-not-allowed" title="Obligatoire">
                   <div className="mt-1">
                   ...
                   <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">Nécessaires pour l'espace membre, le panier et la sécurité des paiements.</p>
                   </div>
                </div>
                ...
                >
                   <div className="mt-1 relative">
                      <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${prefs.analytics ? 'bg-orange-500 border-orange-500' : 'bg-slate-900 border-slate-600'}`}>
                         {prefs.analytics && <Check className="w-3 h-3 text-white" />}
                      </div>
                   </div>
                   <div>
                      <h4 className="text-white font-bold text-sm group-hover:text-orange-400 transition">Analytique & Performance</h4>
                      <p className="text-xs text-slate-400 mt-1">Nous aide à comprendre quelles vidéos sont les plus regardées pour les améliorer.</p>
                   </div>
                </div>
                ...
                >
                   <div className="mt-1 relative">
                      <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${prefs.marketing ? 'bg-orange-500 border-orange-500' : 'bg-slate-900 border-slate-600'}`}>
                         {prefs.marketing && <Check className="w-3 h-3 text-white" />}
                      </div>
                   </div>
                   <div>
                      <h4 className="text-white font-bold text-sm group-hover:text-orange-400 transition">Publicité Ciblée</h4>
                      <p className="text-xs text-slate-400 mt-1">Permet de vous proposer des offres pertinentes (nous en utilisons très peu).</p>
                   </div>
                </div>
             </div>
        ...
        <div className="mt-4 text-center lg:text-left">
           <button onClick={onLearnMore} className="text-xs text-slate-500 hover:text-slate-300 underline">
