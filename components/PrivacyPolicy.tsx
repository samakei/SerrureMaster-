      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none">
          <div className="flex items-center mb-6 border-b border-slate-200 pb-6">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">
                Mise en conformité RGPD – Dernière mise à jour : 21/12/2025
              </p>
            </div>
          </div>

          <p className="text-lg text-slate-700 mb-8">
            Chez <strong>SerrureMaster</strong>, la protection de vos données personnelles est une
            priorité. La présente politique explique de manière transparente comment vos données
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              Les données personnelles sont traitées par SerrureMaster, éditeur du site et
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 text-sm space-y-2">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:dpo@serruremaster.com" className="text-orange-600 hover:underline">
                  dpo@serruremaster.com
                </a>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="mb-2">
              Dans le cadre de l’utilisation du site et des services, nous pouvons collecter les
              données suivantes :
            </p>
            <ul className="list-disc pl-5 space-y-2 text-slate-700 mb-4">
              <li>
                <strong>Données d’identité :</strong> nom, prénom, adresse email
              </li>
              <li>
                <strong>Données de transaction :</strong> historique des achats, identifiants de
                transaction Stripe
              </li>
              <li>
                <strong>Données techniques et de sécurité :</strong> adresse IP, logs de connexion,
                type de navigateur, horodatage des accès aux contenus sécurisés
              </li>
            </ul>
            <div className="p-3 bg-orange-50 text-orange-800 text-sm border-l-4 border-orange-500 rounded-r">
              <strong>⚠️ Important :</strong> SerrureMaster ne stocke aucune donnée bancaire
              complète.
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-5 space-y-1 text-slate-700 mb-4">
              ...
              <li>
                <strong>Sécurité et protection des contenus (intérêt légitime)</strong>
              </li>
            </ul>
            ...
            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Dans un objectif exclusif de lutte contre le piratage et la diffusion non autorisée,
                certaines données techniques (ID utilisateur, adresse IP) peuvent être utilisées
                pour :
              </p>
              ...
              <p className="text-xs italic text-slate-500 border-t border-slate-200 pt-2">
                👉 Ces traitements sont proportionnés, non intrusifs, et ne visent en aucun cas à
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-700">
              <li>
                <strong>Données de compte actif :</strong> durée d’utilisation du service
              </li>
              <li>
          ...
          <section className="mb-10">
            ...
            <p className="mb-2">
              Elles peuvent être transmises uniquement à des sous-traitants techniques nécessaires :
            </p>
            <ul className="list-disc pl-5 space-y-1 text-slate-700 mb-4">
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              ...
              fonctionnement de l’espace membre (authentification, maintien de session).
            </p>
            <div className="p-4 border border-slate-200 rounded-xl bg-slate-50">
              <p className="text-sm text-slate-700 font-medium">
                👉 Ces cookies ne nécessitent pas de consentement préalable, conformément à la
