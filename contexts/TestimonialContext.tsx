...
const MOCK_TESTIMONIALS: Testimonial[] = [
  { id: 't1', name: 'Sophie M.', role: 'Paris 15ème', text: "J'ai économisé 450€ un dimanche soir. Le guide vidéo sur la radio est incroyable, porte ouverte en 3 minutes !", rating: 5, approved: true, date: '2023-11-01', source: 'trustpilot' },
  { id: 't2', name: 'Karim B.', role: 'Lyon', text: "Sceptique au début, mais la méthode du kit de survie fonctionne. Merci pour l'honnêteté.", rating: 5, approved: true, date: '2023-11-05', source: 'google' },
  { id: 't3', name: 'Julie D.', role: 'Marseille', text: "Le support WhatsApp m'a sauvé. J'étais paniquée, Thomas m'a calmée et guidée.", rating: 4, approved: true, date: '2023-10-20', source: 'email' }
];
...
export const TestimonialProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const fetchTestimonials = async () => {
      try {
        ...
        console.warn("Info: Utilisation des témoignages locaux (DB non connectée).", err.message || err);
  ...
  return (
    <TestimonialContext.Provider value={{ testimonials, addTestimonial, updateTestimonial, deleteTestimonial, toggleApproval, resetTestimonials }}>
      {children}
