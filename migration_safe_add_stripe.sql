...
VALUES 
  ...
  ('p6_security_pack', 'Changer sa Serrure en 15 min', 'Remplacez votre serrure sans payer de main-d''œuvre', 100, 'https://images.unsplash.com/photo-1454694220579-9d6672b5ec3a', 'price_1PqY2SD2eZvKYlo2oP6xVs2d'),
  ('p7_audit_security', 'Audit Sécurité & Renforcement', 'Améliorez jusqu''à 80 % de votre sécurité', 100, 'https://images.unsplash.com/photo-1519449419163-5a39223793e5', 'price_1PqY3TE2eZvKYlo2qR5yWt1e'),
  ('p5_survival_kit', 'Pack : Le Kit de Survie', 'La liste exacte du matériel professionnel utile', 29, 'https://images.unsplash.com/photo-1586864387967-d02ef85d93e8', 'price_1PqY4UF2eZvKYlo2rS4zXu0f')
